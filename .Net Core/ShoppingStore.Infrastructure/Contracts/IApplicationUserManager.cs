...
namespace ShoppingStore.Infrastructure.Contracts
{
    public interface IApplicationUserManager
    {
        ...
        Task<List<UserViewModel>> GetPaginateUsersAsync(int offset, int limit, string orderBy, string searchText);
        Task<UserViewModel> FindUserWithRolesByIdAsync(int userId);
